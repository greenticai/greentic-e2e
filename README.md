...
- `greentic-deployer` now provides the AWS region/backend/operator image defaults
- Only `AWS_ACCESS_KEY_ID` and `AWS_SECRET_ACCESS_KEY` are required exports for the local script
